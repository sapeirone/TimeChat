...
class Sample:
    ...
    def __init__(self, video_uid: str, clip_uid: str, video_start_frame: int, video_end_frame: int, label: bool):
        """Ego4d PNR sample.
...
class OSCCDataset(Dataset):
    ...
    def _load_annotations(self, split: str, root: str) -> List[Sample]:
        ...
        for sample in annotations["clips"]:
            ...
            samples.append(Sample(video_uid, unique_id, sf, ef, state_change))

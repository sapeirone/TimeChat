"""Commong utility functions for TimeChat evaluation"""
...
def build_model():
    ...
    model_dir = f"ckpt/timechat/timechat_7b.pth"

    assert osp.exists(model_dir), f"Model checkpoint {model_dir} does not exist."

...
def ask(video_uid, query, timechat_model, timechat_vis_processor, activities_list, num_frames=8, n_icl: int = 0, icl_clips=[], data_path: str = "ego4d_hoi_trimmed_videos/ar", context_window: int = 2048):

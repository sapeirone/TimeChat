#!/bin/bash
#SBATCH --job-name=timechat_mq_icl3                # Job name
...
python -m eval_mq --icl-examples 3 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/mq --ann-path ego4d/annotations/v1/
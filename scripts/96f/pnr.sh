#!/bin/bash
#SBATCH --job-name=timechat_pnr_ZS                     # Job name
...
python -m eval_pnr --icl-examples 0 --num-frames 96 --video-path /beegfs-scratch/speirone/ego4d_videos/oscc --ann-path ego4d/annotations/v1/

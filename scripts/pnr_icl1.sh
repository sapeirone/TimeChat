#!/bin/bash
#SBATCH --job-name=timechat_pnr_icl1                 # Job name
...
python -m eval_pnr --icl-examples 1 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/oscc --ann-path ego4d/annotations/v1/
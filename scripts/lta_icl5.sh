#!/bin/bash
#SBATCH --job-name=timechat_lta_icl5                # Job name
...
python -m eval_lta --icl-examples 5 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/lta --ann-path ego4d/annotations/v1/
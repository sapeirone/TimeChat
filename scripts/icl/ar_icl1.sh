#!/bin/bash
#SBATCH --job-name=timechat_ar_icl1                  # Job name
...
python -m eval_ar --icl-examples 1 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/ar --ann-path ego4d/annotations/v1/
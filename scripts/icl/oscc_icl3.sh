#!/bin/bash
#SBATCH --job-name=timechat_oscc_icl3                # Job name
...
python -m eval_oscc --icl-examples 3 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/oscc --ann-path ego4d/annotations/v1/
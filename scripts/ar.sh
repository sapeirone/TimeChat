#!/bin/bash
#SBATCH --job-name=timechat_ar                      # Job name
...
python -m eval_ar --icl-examples 0 --num-frames 8

echo "Running with 16 frames and 0 icl examples..."
python -m eval_ar --icl-examples 0 --num-frames 16

echo "Running with 32 frames and 0 icl examples..."
python -m eval_ar --icl-examples 0 --num-frames 32

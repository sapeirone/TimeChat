#!/bin/bash
#SBATCH --job-name=timechat_oscc_icl5                # Job name
...
echo "Running with 8 frames and 5 icl examples..."
python -m eval_oscc --icl-examples 5 --num-frames 8 --video-path /beegfs-scratch/speirone/ego4d_videos/oscc --ann-path ego4d/annotations/v1/